  ...
  <div class="container">
    <div class="flex flex-col items-center justify-center gap-8 mt-8">
      ...
      <div class="relative">
        ...
        <svg
          class="absolute right-[-50px] top-[-20px]"
          width="54"
          height="54"
          viewBox="0 0 54 54"
          fill="none"
        ...
        >
          <path
            d="M7.19775 24.7685H46.4254V28.8547H7.19775V24.7685Z"
            fill="#00237D"
          />
          <path
            d="M28.8547 7.19775L28.8547 46.4254H24.7685L24.7685 7.19775L28.8547 7.19775Z"
            fill="#00237D"
          />
          <path
            d="M42.1253 14.3872L14.3872 42.1254L11.4978 39.236L39.2359 11.4978L42.1253 14.3872Z"
            fill="#00237D"
          />
          <path
            d="M39.2359 42.1254L11.4978 14.3873L14.3872 11.4979L42.1253 39.236L39.2359 42.1254Z"
            fill="#00237D"
          />
        </svg>
      </div>
    ...
    <div class="form-customize mt-14 mb-10">
      ...
      <UsersFormsExperience v-if="steps[currentStep].key === 'experience'" :experiences="formState.experiences" @back-step="backStep" @submit="assignData" />
      <UsersFormsSkills v-if="steps[currentStep].key === 'skills'" :skills="formState.skills" @back-step="backStep" @submit="assignData" />
      <UsersFormsAwards v-if="steps[currentStep].key === 'awards'" :awards="formState.awards" @back-step="backStep" @submit="assignData" />
    </div>
    <a-button
      v-if="steps[currentStep].key === 'awards'"
